...
public class CustomAdapterFoodListPrievew extends RecyclerView.Adapter<CustomAdapterFoodListPrievew.ViewHolder> {
    private static final String TAG = "CustomAdapter";

    private List<SelectedFood> mDataSet = new ArrayList<>();
    Context context;
     ...
     */
    public CustomAdapterFoodListPrievew(List<SelectedFood> dataSet) {
        mDataSet = dataSet;
    }
